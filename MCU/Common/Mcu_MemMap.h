...
/*CODE SECTION DECLARATION*/
	/*Start*/
 #ifdef MCU_START_SEC_CODE_LOCAL
		//DEFINE MEMORY SECTION AS CODE 
	#undef MCU_START_SEC_CODE_LOCAL
	#define START_SEC_CODE_LOCAL
 #endif
	/*Stop*/
 #ifdef MCU_STOP_SEC_CODE_LOCAL
		//END THE CODE MEMORY SECTION 
	#undef MCU_STOP_SEC_CODE_LOCAL
