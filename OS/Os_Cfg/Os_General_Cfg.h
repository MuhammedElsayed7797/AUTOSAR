...
{\
    {\
        .AutoStartTasks_Number = 1 , \
        .AutoStartTasks_Index = 0 , \
        .AutoStartAlarms_Number = 0, \
        .AutoStartAlarms_Index = 0, \
        .AutoStartScheduleTables_Number = 0, \
        .AutoStartScheduleTables_Index = 0, \
    }\
}
